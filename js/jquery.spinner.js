...
$('.ticket-table tr').children('td').css('background-color', '#F8F8F8');
$('.destination tr').children('td').css('background-color', '#F8F8F8');
$('.ticket-table tr').children('td:last-child').css('text-align', 'right');
$('.ticket-table tr').children('td:nth-child(2)').css('text-align', 'right');
$('.chat-help').mouseenter(
